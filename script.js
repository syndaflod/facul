...
const initHero = () => {
  ...
  tl.fromTo(".js-hero-eyebrow", { y: 0, opacity: 1 }, { y: -22, opacity: 0.3 }, 0)
    .fromTo(".js-hero-title", { y: 0, scale: 1, opacity: 1 }, { y: -48, scale: 0.94, opacity: 0.52 }, 0)
    .fromTo(".js-hero-text", { y: 0, opacity: 1 }, { y: -26, opacity: 0.45 }, 0)
    .fromTo(".js-hero-card-a", { y: 36, opacity: 0.12 }, { y: -16, opacity: 1 }, 0.1)
    .fromTo(".js-hero-card-b", { y: 54, opacity: 0 }, { y: -8, opacity: 0.92 }, 0.18)
    .fromTo(".js-hero-glow", { scale: 1, xPercent: 0, yPercent: 0 }, { scale: 1.22, xPercent: -8, yPercent: 6 }, 0);
};
...
const initPairSection = (sectionClass, prefix) => {
  ...
  tl.fromTo(`.js-${prefix}-index`, { y: 24, opacity: 0 }, { y: -12, opacity: 1 }, 0.04)
    ...
    .fromTo(`.js-${prefix}-card-1`, { y: 74, opacity: 0, scale: 0.94 }, { y: -12, opacity: 1, scale: 1.02 }, 0.24)
    .fromTo(`.js-${prefix}-card-2`, { y: 90, opacity: 0, scale: 0.92 }, { y: -4, opacity: 1, scale: 1.03 }, 0.3);
};
...
const initMidnight = () => {
  ...
  tl.fromTo(".js-midnight-index", { y: 26, opacity: 0 }, { y: -10, opacity: 1 }, 0.04)
    ...
    .fromTo(".js-midnight-card", { y: 80, opacity: 0, scale: 0.92 }, { y: 0, opacity: 1, scale: 1.02 }, 0.24);
};
